...
resultsOfSingleFight SingleFight(std::shared_ptr<Entity> attacker, std::shared_ptr<Entity> victim) {
...
resultsOfFights FightStatistics(std::shared_ptr<Entity> attacker, std::shared_ptr<Entity> victim, int numbFights) {
    int attackerWins = 0;
    int victimWins = 0;
